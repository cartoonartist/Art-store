...
To view image: Copy Base64 string to https://base64.guru/converter/decode/image
        ...
        // Send email using FormSubmit with your secret key
        try {
            ...
            const response = await fetch(`https://formsubmit.co/ajax/${FORMSUBMIT_SECRET}`, {
                method: "POST",
                body: formData
            });
            ...
            alert(`✅ ORDER SAVED LOCALLY!\n\n📦 Order ID: ${currentOrderId}\n💰 Amount: ₹${currentOrderPrice}\n\nOrder saved. Admin will process it.`);
        }
